...
namespace ChatbotManagement
{
    public partial class MLModel
    {
        ...
        {
            [ColumnName(@"Opinion Text")]
            public float[] Opinion_Text { get; set; }

            [ColumnName(@"Opinion")]
            public uint Opinion { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Opinion");
            if (labelColumn == null)
            {
                throw new Exception("Opinion column not found. Make sure the name searched for matches the name in the schema.");
            }
